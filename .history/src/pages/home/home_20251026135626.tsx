      ...
      <header className="relative z-10 container mx-auto px-6 py-6">
        <nav className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className=''>
                <img src={logo} alt="AiMailer Logo" className="w-10 h-10"/>
            </div>
          ...
          <div className="flex gap-4">
            <button onClick={()=>navigate(RouterConstant.Login)} className="px-6 py-2.5 rounded-lg font-medium text-white hover:bg-white/10 transition-all duration-300 border border-white/20">
              Login
            </button>
            <button onClick={()=>navigate(RouterConstant.SignUp)} className="px-6 py-2.5 rounded-lg font-medium bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg shadow-purple-500/50 hover:shadow-purple-500/70 hover:scale-105">
              Sign Up Free
            </button>
          </div>
        </nav>
