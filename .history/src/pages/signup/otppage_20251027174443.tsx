  ...
  return (
    <div className="min-h-screen w-full bg-white">
      ...
      <div className="hidden lg:block h-screen w-screen overflow-hidden relative">
        ...
        <div className="absolute  left-[88px] max-w-[630px] max-h-[594px] flex flex-col gap-[42px]">
          {/* Logo and Brand */}
          <div className="max-w-[280px] max-h-[84px] opacity-100 flex items-center ">
            <img src={logo} alt="Aimailer" />
          </div>
