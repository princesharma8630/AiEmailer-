    ...
    <div className="h-screen w-screen overflow-hidden relative bg-white">
      ...
      <div className="justify-self-center absolute top-[50px] left-[800px] w-[493px] h-[509px] rounded-2xl pt-8 pr-[22px] pb-8 pl-[22px] flex flex-col gap-2.5 bg-gray-50 shadow-sm">
        ...
        <div className="gap">
          ...
          <div>
            <fieldset
              className={`w-[449px] h-12 border rounded-sm px-4 pb-3 mt-1 mb-2 flex items-center focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500 ${fieldErrors.password && touched.password ? 'border-red-500' : 'border-gray-300'
                }`}
            >
              <legend className="px-1 text-sm font-medium text-gray-700">
                Password
