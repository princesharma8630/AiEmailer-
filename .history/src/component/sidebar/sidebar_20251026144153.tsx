...
const Sidebar = ({ isOpen, onClose, activeItem, setActiveItem }: SidebarProps) => {
  ...
  const menuItems = [
    ...
    { name: 'Bulk Email', icon: <BulkEmailIcon />, route:RouterConstant },
    { name: 'Schedule Emails', icon: <ScheduleEmailsIcon />, route: '/schedule-emails' },
    { name: 'Custom Emails', icon: <CustomEmailsIcon />, route: '/custom-emails' },
