...
const Sidebar = ({ isOpen, onClose, activeItem, setActiveItem }: SidebarProps) => {
  ...
  const menuItems = [
    ...
    { name: 'Custom Emails', icon: <CustomEmailsIcon />, route: RouterConstant.CUSTOM_EMAILS },
    { name: 'Email Signatures', icon: <EmailSignaturesIcon />, route: RouterConstant.EMAIL_SIGNATURES },
